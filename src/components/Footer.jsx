      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-6 border-t border-gray-800">
          <p className="text-xs text-gray-500 text-center max-w-3xl mx-auto leading-relaxed">
            Empresa independiente de servicios técnicos de calefacción. Las marcas mencionadas en este sitio se utilizan únicamente para identificar equipos compatibles y no implican afiliación, autorización ni representación de los fabricantes.
          </p>
        </div>

        {/* Copyright */}
        <div className="py-4 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4">
